...
func request_Files_Upload_0(ctx context.Context, marshaler runtime.Marshaler, client FilesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterFilesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FilesServer) error {
	...
	mux.Handle("POST", pattern_Files_Upload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterFilesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FilesClient) error {
	...
	mux.Handle("POST", pattern_Files_Upload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Files_Upload_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Files_Upload_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Files_Upload_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"upload"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Files_Upload_0 = runtime.ForwardResponseMessage
)
